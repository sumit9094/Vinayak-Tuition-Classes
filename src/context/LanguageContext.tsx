...
const translations: Record<Language, Record<string, string>> = {
  EN: {
    ...
    authSuccessRegister: "Account created! Please login.",
    authPasswordValidationErr: "Password must be at least 8 chars, with 1 uppercase & 1 number",
    authConfirmPasswordErr: "Passwords do not match",
    authNameErr: "Name must be at least 3 characters",
    authPhoneErr: "Please enter a valid 10-digit mobile number",
    authEmailErr: "Please enter a valid email address",
    authDashboardComingSoon: "Admin Dashboard - Coming Soon!",
    authDashboardDesc: "You have logged in successfully. The full dashboard with student management will be added in the next phase.",
  ...
  GJ: {
    ...
    // Auth pages
    authRegisterTitle: "એકાઉન્ટ બનાવો",
    authLoginTitle: "આપનું સ્વાગત છે",
    authFullNameLabel: "પૂરું નામ",
    authFullNamePlaceholder: "તમારું પૂરું નામ દાખલ કરો",
    authEmailLabel: "ઈમેલ સરનામું",
    authEmailPlaceholder: "તમારો ઈમેલ દાખલ કરો",
    authPhoneLabel: "ફોન નંબર",
    authPhonePlaceholder: "૧૦-આંકડાનો મોબાઈલ નંબર",
    authPasswordLabel: "પાસવર્ડ",
    authPasswordPlaceholder: "પાસવર્ડ દાખલ કરો",
    authConfirmPasswordLabel: "પાસવર્ડની પુષ્ટિ કરો",
    authConfirmPasswordPlaceholder: "પાસવર્ડ ફરીથી દાખલ કરો",
    authRoleLabel: "ભૂમિકા પસંદ કરો",
    authRoleAdmin: "એડમિન",
    authRoleTeacher: "શિક્ષક",
    authCreateAccountBtn: "એકાઉન્ટ બનાવો",
    authLoginBtn: "લોગીન કરો",
    authSubmitting: "એકાઉન્ટ બની રહ્યું છે...",
    authLoggingIn: "લોગીન થઈ રહ્યું છે...",
    authAlreadyAccount: "પહેલેથી એકાઉન્ટ છે? લોગીન કરો",
    authNoAccount: "એકાઉન્ટ નથી? નોંધણી કરો",
    authForgotPassword: "પાસવર્ડ ભૂલી ગયા છો?",
    authInvalidCredentials: "અમાન્ય ઈમેલ અથવા પાસવર્ડ",
    authSuccessRegister: "એકાઉન્ટ બનાવવામાં આવ્યું છે! કૃપા કરીને લોગીન કરો.",
    authPasswordValidationErr: "પાસવર્ડ ઓછામાં ઓછો ૮ અક્ષરનો હોવો જોઈએ, જેમાં ૧ કેપિટલ અને ૧ નંબર હોવો જરૂરી છે",
    authConfirmPasswordErr: "પાસવર્ડ મેચ થતા નથી",
    authNameErr: "નામ ઓછામાં ઓછું ૩ અક્ષરનું હોવું જોઈએ",
    authPhoneErr: "કૃપા કરીને સાચો ૧૦-આંકડાનો મોબાઈલ નંબર દાખલ કરો",
    authEmailErr: "કૃપા કરીને સાચું ઈમેલ સરનામું દાખલ કરો",
    authDashboardComingSoon: "એડમિન ડેશબોર્ડ - ટૂંક સમયમાં આવી રહ્યું છે!",
    authDashboardDesc: "તમે સફળતાપૂર્વક લોગ ઇન કર્યું છે. વિદ્યાર્થી સંચાલન સાથેનું સંપૂર્ણ ડેશબોર્ડ આગામી તબક્કામાં ઉમેરવામાં આવશે.",
    authLogoutBtn: "સાઇન આઉટ",
    authBackHome: "હોમ પેજ પર પાછા જાઓ"
  }
};
