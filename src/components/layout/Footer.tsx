      ...
      <div className="container mx-auto px-6 lg:px-12 relative z-10">
        ...
        <div className="border-t border-slate-200 dark:border-slate-850 pt-8 flex flex-col md:flex-row items-center justify-between text-sm text-slate-500 font-medium">
          ...
          <div className="flex space-x-4 mt-4 md:mt-0">
            <Link href="/privacy-policy" className="hover:text-accentViolet dark:hover:text-accentViolet transition-colors">{t('footerPrivacy')}</Link>
            <Link href="/terms-of-service" className="hover:text-accentViolet dark:hover:text-accentViolet transition-colors">{t('footerTerms')}</Link>
          </div>
        </div>
      </div>
    </footer>
